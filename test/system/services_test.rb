...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Load Waiting Sec", with: @service.load_waiting_sec
    fill_in "Name", with: @service.name
    fill_in "Number Of Occurrences", with: @service.number_of_occurrences
    fill_in "Text On Page", with: @service.text_on_page
